...
/*Write a java program to input studnet name, rolll no, and there subjects math, Science and English marks
( marks is between 0 to 100 and if it si out of range print error message "Invalid Inputs, Marks should between 0 to
 100") and find out total , percentage and results.
 if he is pass or ail aon basis of percentage (pass >=35) and also five them grade if %> = 80 A+, %> = 60 A, %> = 50
 B, %> = 35 C and print mark sheetin following format
